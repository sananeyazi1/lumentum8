...
class __TwigTemplate_14b9f36834142833919c4cd4533d09f8e5bd0854e7aa3f3bd1e88db32468e563 extends \Twig\Template
{
    ...
    {
        return new Source("{# inline_template_start #}{{ error }} {{ description }}", "{# inline_template_start #}{{ error }} {{ description }}", "");
    }
}
